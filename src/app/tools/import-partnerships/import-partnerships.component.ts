...
@Component({
  selector: 'app-import-partnerships',
  standalone: true,
  imports: [MaterialModule, CommonModule],
  templateUrl: './import-partnerships.component.html',
  styleUrl: './import-partnerships.component.sass'
})
export class ImportPartnershipsComponent {
